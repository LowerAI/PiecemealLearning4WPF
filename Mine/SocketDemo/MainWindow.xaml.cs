...
namespace SocketAndNamedPipeDemo
{
    ...
    /// .NET下WPF学习之Socket通信 - Memoyu - 博客园 https://www.cnblogs.com/memoyu/p/10764884.html
    /// </summary>
    public partial class MainWindow : Window
    {
        ...
        private void MainWindow_Closing(object sender, CancelEventArgs e)
        {
            ...
            //msdn的解释：foreach 语句是对枚举数的包装，它只允许从集合中读取，不允许写入集合。也就是,不能foreach里遍历的时侯把它的元素进行删除或增加的操作的
